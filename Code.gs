...
function enviarEmails(dados, resumo, pdfBlob) {
  ...
  var labelCampo = {
    ...
    filhos:                 'Filhos',
    filhos_info:            'Informações filhos',
    deseja_gestar:          'Deseja gestar?',
    ...
    altura:                 'Altura (cm)',
    maior_peso:             'Maior peso atingido',
    menor_peso:             'Menor peso adulto',
    ...
    // Hidratacao e habitos
    agua:                   'Consumo de água/dia',
    alcool:                 'Consumo de álcool',
    tabagismo:              'Tabagismo',
    // Alimentacao
    num_refeicoes:          'Nº de refeições/dia',
    ...
    freq_evacuatoria:       'Frequência evacuatória',
    // Saude feminina
    libido:                 'Libido',
    ciclo:                  'Ciclo menstrual',
    fluxo:                  'Fluxo menstrual',
    tpm:                    'Sintomas de TPM',
    sint_menopausa:         'Sintomas menopausa',
    anticoncepcional:       'Anticoncepcional?',
    anticoncepcional_info:  'Qual anticoncepcional',
    trh_f:                  'TRH feminino?',
    trh_f_info:             'Qual TRH',
    diag_gineco:            'Diagnósticos ginecológicos',
    // Saude masculina
    libido_m:               'Libido (masc.)',
    erecao:                 'Função erétil',
    erecao_matinal:         'Ereção matinal',
    sint_andropausa:        'Sintomas andropausa',
    uso_testo:              'Uso de testosterona?',
    testo_info:             'Qual testosterona',
    fertilidade_m:          'Fertilidade masculina',
    // Saude mental (triagem)
    phq_1:                  'PHQ – Humor (resposta)',
    gad_1:                  'GAD – Ansiedade (resposta)',
    ...
    diag_autoimune:         'Doenças autoimunes',
    ...
    alergia_alimento_info:  'Qual alergia alimentar',
    alergia_med:            'Alergia a medicamento?',
    alergia_med_info:       'Qual alergia medicamento',
    ...
    tem_exames:             'Possui exames recentes?',
